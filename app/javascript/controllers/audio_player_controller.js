...
export default class extends Controller {
  static targets = ["audio", "playButton", "progressBar", "progressFill", "timeDisplay", "speedButton"]
  ...
  connect() {
    ...
    console.log("Has all targets:", this.hasAudioTarget, this.hasPlayButtonTarget, this.hasProgressBarTarget)
    
    this.audioTarget.playbackRate = 1.0
    
    // Update duration when metadata loads
    this.audioTarget.addEventListener('loadedmetadata', () => {
      console.log("✅ Audio metadata loaded, duration:", this.audioTarget.duration)
