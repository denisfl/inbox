...
var document_editor_controller_default = class extends Controller {
  ...
  // 2. Enhanced keydown handler with markdown shortcuts, slash commands, and keyboard shortcuts
  handleKeydownEnhanced(event) {
    console.log("handleKeydownEnhanced called", event.key, event.metaKey, event.shiftKey);
  ...
  // 5. Get default content for each block type
...
@hotwired/turbo/dist/turbo.es2017-esm.js:
   ...
   *)
*/
//# sourceMappingURL=/assets/application-91ff8d87.js.map
