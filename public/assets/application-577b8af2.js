    ...
    if (event.key === "Enter" && !event.shiftKey && !event.metaKey && !event.ctrlKey) {
      ...
      if (blockWrapper && activeElement.hasAttribute("contenteditable")) {
        ...
        if (blockType === "text") {
          ...
          console.log("\u{1F50D} Enter key pressed in text block, text:", JSON.stringify(text));
          console.log("\u{1F50D} Is markdown shortcut?", this.isMarkdownShortcut(text));
          if (this.isMarkdownShortcut(text)) {
            console.log("\u2705 Markdown pattern detected! Converting...");
            event.preventDefault();
...
@hotwired/turbo/dist/turbo.es2017-esm.js:
   ...
   *)
*/
//# sourceMappingURL=/assets/application-cf93ec7c.js.map
