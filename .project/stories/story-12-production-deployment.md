...
4. **Update DNS:**
   - Add A record: `your-domain.com` → Your DO server IP
...
6. **Test access:**
   ...
   # Telegram bot can POST to https://your-domain.com/api/telegram/webhook
   ```

**Result:**

- Raspberry Pi accessible via `https://your-domain.com`
