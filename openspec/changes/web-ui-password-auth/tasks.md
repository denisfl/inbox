...
- [ ] 5.1 Open `https://your-domain.com/` in browser → should see Basic Auth password prompt
...
- [ ] 5.5 Confirm `curl -s https://your-domain.com/api/telegram/webhook` does NOT return 401 (returns 403 from Telegram secret validation or 405)
