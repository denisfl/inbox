...
The web UI at `https://inbox.fedosov.me` is currently inaccessible (nginx returns 403 for all non-webhook routes). As a single user, I need password-protected access to browse, search, and manage my notes from any device (browser on desktop/mobile).
